...
import pandas as pd
import os
import gcj02_to_wgs84 as tcs

#   import gcj02_to_wgs84

# key(必选)
amp_api_key = 'a195daf5b2babc96fd87d2310513a95e'
#  请求地址前缀
req_url_pref = "https://restapi.amap.com/v3/place/around?"
# 分页信息(可选)
...
def get_poi_from_amap():
    ...
    while True:
        ...
        for j in range(0, len(data["pois"])):  # 遍历每一个poi对象，获取name,address等属性
            ...
            print(result)
            # 将脚本所在路径作为excel输出路径
            output_path = os.getcwd() + os.sep + "poi_elder_activity.xlsx"
